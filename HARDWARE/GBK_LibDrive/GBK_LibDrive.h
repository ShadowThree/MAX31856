...
//#define	FCS_SET  	GPIO_SetBits(GPIOB,GPIO_Pin_12)      //PB12置1        LCD_CS：  PB12 //片选	  
//#define	FCS_CLR  	GPIO_ResetBits(GPIOB,GPIO_Pin_12)    //PB12置0/CS     LCD_CS：  PB12 //片选	

//#define	FDI_SET   GPIO_SetBits(GPIOB,GPIO_Pin_15)      //PB15置1        LCD_SDI： PB15 //数据输入线
//#define	FDI_CLR   GPIO_ResetBits(GPIOB,GPIO_Pin_15)    //PB15置0 //DIN  LCD_SDI： PB15 //数据输入线

//#define	FCLK_SET   GPIO_ResetBits(GPIOB,GPIO_Pin_13)    //PB13置0 //CLK  LCD_SCL： PB13 //时钟线
//#define	FCLK_CLR   GPIO_SetBits(GPIOB,GPIO_Pin_13)      //PB13置1        LCD_SCL： PB13 //时钟线

//#define	FDO_IN    GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)    //PB14置0 //RES  LCD_SDO ：PB14 //数据输出/复位
